define(['modules/jquery-mozu', 'underscore', "modules/api", "modules/backbone-mozu", "modules/models-product","shim!vendor/owl.carousel[jquery=jQuery]>jQuery"],
    function ($, _, api, Backbone, ProductModels) {
        ...
        $(document).ready(function() {
            ...
            $('[data-mz-related-products]').each(function (index, rp) {
                ...
                var template = config.template || 'modules/product/crosssell';
