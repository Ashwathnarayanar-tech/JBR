...
(function (root, factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        // Browser globals
        root.IframeXMLHttpRequest = factory();
    }
}(this, function () {
    var extend = function () {
    ...
    var IframeXMLHttpRequest = function (frameUrl, options) {
        options = options || {};
        this.options = options;
        var frameMatch = frameUrl.match(originRE);
        if (!frameMatch || !frameMatch[0]) {
            if (this.options.strictCrossDomain) {
                throw new Error(frameUrl + " does not seem to have a valid origin.");
            } else {
                frameMatch = frameUrl;
            }
        }
    ...
    extend(IframeXMLHttpRequest.prototype, messageMethods, {
        readyState: 0,
        status: 0,
